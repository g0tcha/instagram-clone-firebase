...
//        button.tintColor = UIColor(white: 0, alpha: 0.2)
    ...
    private func setupBottomToolbar() {
        ...
        topDividerView.anchor(top: stackView.topAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 00, width: 0, height: 0.5)
